...
export default function Marketplace(){
 ...
 const selectedId=typeof window!=="undefined"?new URLSearchParams(window.location.search).get("product"):null;
